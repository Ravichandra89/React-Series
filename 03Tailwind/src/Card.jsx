...
function Card({ username = "RV", src ,post="Web Developer"}) {
  return (
    <div>
      <figure className="md:flex bg-slate-100 rounded-xl p-8 md:p-0 dark:bg-slate-800">
        ...
        <div className="pt-6 md:p-8 text-center md:text-left space-y-4">
          ...
          <figcaption className="font-medium">
            <div className="text-sky-500 dark:text-sky-2000 text-2xl">
              {username}
            </div>
            <div className="text-slate-700 dark:text-slate-500 text-3xl">
                {post}
            </div>
          </figcaption>
        </div>
